...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('members_member', 'city_id')

        # Adding field 'Member.location'
        db.add_column('members_member', 'location',
    ...
    def backwards(self, orm):
        ...
        db.add_column('members_member', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['members.City']),
                      keep_default=False)

        # Deleting field 'Member.location'
        db.delete_column('members_member', 'location')
