    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(to='members.Category', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='last_transaction', blank=True, to='payment.Transaction', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='payment',
            name='member',
        ...
        migrations.AddField(
            model_name='payment',
            name='type',
            field=models.ForeignKey(to='payment.PaymentType', on_delete=models.CASCADE),
        ),
    ]
