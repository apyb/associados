...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('payment_transaction', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.date'
        db.delete_column('payment_transaction', 'date')
    ...
    models = {
        ...
        'members.member': {
            ...
            'github_user': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
