...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.last_transaction'
        db.add_column('payment_payment', 'last_transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_transaction', null=True, to=orm['payment.Transaction']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.last_transaction'
        db.delete_column('payment_payment', 'last_transaction_id')
    ...
    models = {
        ...
        'payment.payment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_transaction': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'last_transaction'", 'null': 'True', 'to': "orm['payment.Transaction']"}),
